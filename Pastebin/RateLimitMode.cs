namespace Pastebin
{
    ...
    {
        /// <summary>
        /// Do not enforce rate limiting.
        /// This is not recommended and a high volume of requests can lead to a temporary IP ban.
        /// Repeated offenses can lead to a permanent IP ban.
        /// </summary>
        Disabled,
